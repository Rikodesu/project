...
output  [15:0] conv_i_i_i137_i_out;
output   conv_i_i_i137_i_out_ap_vld;

reg ap_idle;
reg out_Dense_ce0;
reg conv_i_i_i137_i_out_ap_vld;
...
wire    ap_loop_init;
reg   [15:0] conv_i_i_i137_i_fu_44;
...
always @ (*) begin
    if (((icmp_ln28_fu_96_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        conv_i_i_i137_i_out_ap_vld = 1'b1;
    end else begin
        conv_i_i_i137_i_out_ap_vld = 1'b0;
    end
end
...
assign conv_i_i_i137_i_out = conv_i_i_i137_i_fu_44;
...
assign select_ln29_fu_141_p3 = ((icmp_ln29_fu_124_p2[0:0] == 1'b1) ? zext_ln29_fu_137_p1 : conv_i_i_i137_i_fu_44);
