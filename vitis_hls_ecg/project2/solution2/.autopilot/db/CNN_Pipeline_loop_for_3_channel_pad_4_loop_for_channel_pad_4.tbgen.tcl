...
set C_modelArgList {
	{ OutPadConv4 int 16 regular {array 672 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_4ns_7ns_7ns_10_4_1_U118", "Parent" : "0"},
...
set Spec2ImplPortList { 
	OutPadConv4 { ap_memory {  { OutPadConv4_address0 mem_address 1 10 }  { OutPadConv4_ce0 mem_ce 1 1 }  { OutPadConv4_we0 mem_we 1 1 }  { OutPadConv4_d0 mem_din 1 16 } } }
	OutPool1 { ap_memory {  { OutPool1_address0 mem_address 1 10 }  { OutPool1_ce0 mem_ce 1 1 }  { OutPool1_q0 in_data 0 16 } } }
}
