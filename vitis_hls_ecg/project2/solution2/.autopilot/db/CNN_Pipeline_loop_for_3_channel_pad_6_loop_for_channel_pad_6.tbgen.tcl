...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_5ns_6ns_6ns_10_4_1_U176", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	OutPool2 { ap_memory {  { OutPool2_address0 mem_address 1 10 }  { OutPool2_ce0 mem_ce 1 1 }  { OutPool2_q0 in_data 0 16 } } }
}
