...
class RealDataset(Sequence):
    ...
    def get_waveform(self, idx):
        ...
        #raw_signal, fields = wfdb.rdsamp(self.waveform_dir + '/' + str(self.dataset['filename_lr'][idx]))
        ...
        target = self.dict_label[label[0]]
...
if __name__ == '__main__':
    ...
    print(x_test.shape)
    print(y_test.shape)
    np.savetxt('signals1.txt', x_test)
    np.savetxt('labels1.txt', y_test, fmt='%.d')
